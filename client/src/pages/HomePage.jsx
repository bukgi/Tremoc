...
const ProductCard = ({ product, index }) => {
  ...
  const handleQuickViewAddToCart = async () => {
    if (isOutOfStock || adding) return;
    setAdding(true);
    const result = await addToCart(product, quickViewQty);
    setAdding(false);
    if (!result.success) {
      setToast({ type: "error", message: result.message });
    } else {
      setToast({
        type: "success",
        message: `Đã thêm ${quickViewQty} sản phẩm vào giỏ hàng!`,
      });
    }
    setTimeout(() => setToast(null), 2500);
  };
  ...
  return (
    <>
      ...
      >
        ...
        {toast && (
          <div
            className={`absolute top-2 left-2 right-2 z-20 px-3 py-2 rounded-lg text-xs font-medium text-white shadow-lg transition-all duration-300 flex items-center gap-2 ${
        ...
        <Link
          ...
          className="block relative overflow-hidden aspect-square bg-bg-off"
        >
          <img
            src={product.image}
            alt={product.name}
          ...
          <div className="absolute inset-0 flex items-center justify-center opacity-0 group-hover:opacity-100 transition-opacity duration-300 z-10">
            <button
              ...
              className="flex items-center gap-2 bg-white/90 backdrop-blur-sm text-slate-dark font-semibold text-sm px-5 py-2.5 rounded-full shadow-lg hover:bg-white hover:shadow-xl transition-all duration-300 hover:scale-105"
            >
              <Eye size={17} />
              Xem nhanh
            </button>
      ...
      {quickViewOpen && (
        ...
        >
          ...
          >
            ...
            <button
              onClick={closeQuickView}
              className="absolute top-4 right-4 z-10 w-9 h-9 bg-white/90 backdrop-blur-sm rounded-full flex items-center justify-center shadow-md hover:bg-gray-100 transition-all"
            >
              <X size={18} className="text-slate-dark" />
            </button>

            <div className="grid grid-cols-1 md:grid-cols-2 gap-0">
              {/* Image */}
              <div className="aspect-square bg-bg-off rounded-t-2xl md:rounded-l-2xl md:rounded-tr-none overflow-hidden">
                <img
                  src={product.image}
                  alt={product.name}
              ...
              <div className="p-6 flex flex-col">
                ...
                <h2 className="text-xl font-bold text-slate-dark mt-1.5 mb-2">
                  {product.name}
                </h2>
                <p className="text-2xl font-bold text-forest mb-3">
                  {formatPrice(product.price)}
                </p>
                ...
                >
                  ...
                  {isOutOfStock
                    ? "Hết hàng"
                    : isLowStock
                      ? `Sắp hết — Còn ${product.stockQuantity} sản phẩm`
                    ...
                    className={`w-full flex items-center justify-center gap-2 font-semibold py-3 rounded-xl transition-all duration-300 ${
                      isOutOfStock
                        ...
                        : adding
                          ...
                          : "bg-forest hover:bg-forest-dark text-white hover:shadow-lg hover:shadow-forest/25 active:scale-[0.98]"
                    }`}
                  >
...
const HomePage = () => {
  ...
  const [banner, setBanner] = useState(() => {
    ...
    const initialBanner = {
      ...
      description:
        "Khám phá bộ sưu tập sản phẩm tre thủ công cao cấp, được chế tác tỉ mỉ từ các làng nghề truyền thống Việt Nam.",
  ...
  const getMilestone = (count) => {
    if (count <= 5) {
      ...
      return {
        ...
        color:
          "bg-green-50 text-green-700 border-green-200 animate-bounceSubtle",
      };
    } else {
      return {
        emoji: "🌍",
    ...
    <div>
      ...
      <section className="relative bg-gradient-to-br from-mint-light via-cream to-mint overflow-hidden">
        <div className="absolute inset-0 opacity-40">
          ...
          <div
            className="absolute bottom-10 right-20 w-96 h-96 bg-bamboo/20 rounded-full blur-3xl animate-float"
        ...
        <div className="relative max-w-[1440px] mx-auto px-4 sm:px-6 lg:px-8 py-16 lg:py-24">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-16 items-center">
            ...
            <div className="text-center lg:text-left">
              ...
              <p
                className="text-lg text-muted max-w-xl mx-auto lg:mx-0 mb-8 animate-slideUp"
            ...
            >
              ...
              <div className="absolute -bottom-6 -left-4 sm:left-4 bg-white rounded-2xl p-3 shadow-xl border border-border/50 animate-float">
                <img
                  src="/images/bamboo_cups.png"
                  alt="Bộ cốc tre"
                  className="w-24 h-24 rounded-xl object-cover"
                />
              </div>
              <div
                className="absolute -top-4 -right-4 sm:right-4 bg-white rounded-full p-2 shadow-xl border border-border/50 animate-float"
              ...
              <div
                className="absolute top-1/3 -right-6 hidden sm:block bg-white rounded-2xl p-2 shadow-xl border border-border/50 animate-float"
                style={{ animationDelay: "1.2s" }}
              >
                <img
                  src="/images/bamboo_tea_tray.png"
                  alt="Khay trà tre"
            ...
            {[
              {
                icon: Leaf,
                label: "100% Tự nhiên",
                desc: "Nguyên liệu bền vững",
              },
              { icon: TreePine, label: "Thủ công", desc: "Làng nghề Việt Nam" },
              {
                icon: Shield,
                label: "An toàn",
                desc: "Không hóa chất độc hại",
              },
      ...
      <section className="max-w-[1440px] mx-auto px-4 sm:px-6 lg:px-8 py-16 lg:py-20">
        <div className="text-center mb-12">
          <h2 className="text-3xl lg:text-4xl font-bold text-slate-dark mb-3">
            Sản phẩm nổi bật
          </h2>
      ...
      <section className="bg-mint-light py-16 lg:py-20 border-t border-b border-forest/10 relative overflow-hidden">
        ...
        <div className="max-w-[1440px] mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center max-w-3xl mx-auto mb-14">
            <span className="text-xs font-bold text-forest uppercase bg-forest/10 px-3 py-1.5 rounded-full tracking-wider">
              Hồn Tre Đất Việt
            </span>
            ...
            <p className="text-muted text-base">
              Chúng tôi kết hợp nguồn nguyên liệu tre dồi dào, thân thiện với
              quy trình sản xuất thủ công tỉ mỉ tại các làng nghề truyền thống
              Việt Nam để mang đến vẻ đẹp mộc mạc, bền bỉ nhất.
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            {[
              ...
              >
                ...
                <div className="p-6">
                  <h4 className="text-lg font-bold text-slate-dark mb-2 group-hover:text-forest transition-colors">
                    {item.title}
                  </h4>
      ...
      <section className="max-w-[1440px] mx-auto px-4 sm:px-6 lg:px-8 py-16 lg:py-20">
        <div className="text-center mb-12">
          ...
          <h2 className="text-3xl lg:text-4xl font-bold text-slate-dark mt-4 mb-3">
            Khoảnh Khắc Sống Xanh
          </h2>
          <p className="text-muted text-lg max-w-xl mx-auto">
            Những hình ảnh về sản phẩm tre và lối sống bền vững cùng Tre Mộc
          </p>
        </div>
        <div className="grid grid-cols-2 md:grid-cols-4 gap-3 md:gap-4">
          {[
            {
              src: "/images/lookbook-tea.jpg",
              alt: "Trà chiều",
            ...
            {
              src: "/images/bamboo_organizer.png",
              alt: "Hộp bút tre",
              span: "",
            },
            {
              src: "/images/lookbook-kitchen.jpg",
              alt: "Nhà bếp xanh",
              span: "col-span-2",
            },
          ].map((img, i) => (
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-12 items-center">
            ...
            <div className="lg:col-span-5 bg-white rounded-3xl p-6 sm:p-8 shadow-xl border border-forest/10 animate-fadeIn">
              ...
              <p className="text-muted text-sm leading-relaxed mb-6">
                Chọn số lượng vật dụng nhựa (cốc, bát, ống hút, bàn chải...) bạn
                sẽ thay thế bằng sản phẩm tre tự nhiên và nhìn thấy tác động tức
                thì:
              </p>
              ...
              <div
                className={`rounded-2xl p-4 border transition-all duration-500 ${milestone.color}`}
              >
            ...
            <div className="lg:col-span-7 space-y-6">
              <div className="max-w-xl">
                ...
                <p className="text-muted text-base leading-relaxed">
                  Bản tính toán đo lường gần đúng lượng chất thải được loại bỏ
                  trực tiếp khỏi môi trường dựa trên lượng nguyên liệu tre sạch
                  tiêu hao.
                </p>
              </div>
              ...
              <div className="grid grid-cols-1 sm:grid-cols-3 gap-5">
                {[
                  {
                    value: `${plasticSaved}g`,
                    label: "Nhựa tránh được",
                    desc: "Lượng chất thải nhựa không bị xả ra bãi rác hoặc đại dương.",
                    emoji: "🌿",
                    color:
                      "border-emerald-200 shadow-emerald-50 text-emerald-600",
                  },
                  {
                    value: `${co2Saved}kg`,
                    label: "CO₂ giảm thiểu",
                    desc: "Khí nhà kính giảm thiểu nhờ chọn vật liệu tre có chu kỳ carbon âm.",
                    emoji: "🌲",
                    color: "border-green-200 shadow-green-50 text-green-600",
                  },
                  {
                    value: `${waterSaved}L`,
                    label: "Nước tiết kiệm",
                    desc: "Lượng nước ngọt được bảo tồn so với quy trình tinh chế hạt nhựa tổng hợp.",
                    emoji: "💧",
                    color: "border-blue-200 shadow-blue-50 text-blue-500",
                  },
                  ...
                  >
                    ...
                    <p
                      className="text-3xl font-extrabold text-slate-dark mt-1 animate-scaleIn"
                      key={value}
                    >
                      {value}
                    </p>
